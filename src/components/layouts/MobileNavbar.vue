        ...
        <div class="container">
            <div class="navbar__mobile-header">
                <div class="navbar__mobile-logo-container">
                    <router-link to="/">
                        <img src="@/assets/images/navbar/logo-mobile-black.svg" alt="" class="mobile__navbar-logo">
                    </router-link>
                </div>
            ...
            <nav class="navbar__mobile-nav">
                <ul class="navbar__mobile-ul">
                    <li v-for="link in navList" :key="link">
                        <router-link :to="link.path" class="navbar__mobile-link">{{ link.text }}</router-link>
                    </li>
                </ul>
            </nav>
